...
# r-to-spec — Gespräch zur Spec verdichten

## Zweck (1 Satz)

Aus dem, was im Gespräch und im Code bereits geklärt ist, eine PRD-Spec bauen — ohne den
User erneut zu interviewen (dafür ist `r-grill` da).
...
- Interviewen ist NICHT der Job dieses Skills — dafür `r-grill` nutzen, davor oder separat.
