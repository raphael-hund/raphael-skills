...
# r-handoff-ext — Übergabe an eine andere Instanz

**Abgrenzung zu r-handoff:** `r-handoff` ist unser eigenes Session-Ritual
(PROGRESS.md/DECISIONS.md, Commit+Push, hartes `/clear`) für die eigene nächste Session im
selben Repo. `r-handoff-ext` deckt den Fall ab, dass **eine andere Instanz** weitermacht —
...
- Verwechslung mit r-handoff vermeiden: hier kein Commit/Push-Zwang, kein PROGRESS.md — das
