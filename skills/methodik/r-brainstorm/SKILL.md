...
description: >
  ...
  danach an r-plan. Trigger: "brainstorm", "Idee ausarbeiten", "Design-Spec",
  "bevor wir loslegen", "Anforderungen klären".
class: M
scope: agency
sensitivity: internal
source: vendored from superpowers (obra) skills/brainstorming @ d884ae04
completion_criteria:
...
# r-brainstorm — Idee zur freigegebenen Spec
...
9. **Übergabe an r-plan** — nach Freigabe. Kein anderer Implementierungsskill
   folgt direkt auf r-brainstorm.
