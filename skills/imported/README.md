...
Bestand: `last30days` (Recency-/Social-Research, aus last30days-skill/mvanhorn @ 249c7a4c,
...
3. Umbenennen in den -Namespace (Kollisionsfreiheit).
...
6. Jeder vendorte Skill bekommt sein eigenes `VENDORING.md` nach Vorbild
   `skills/design/VENDORING.md`.

Siehe auch `skills/design/` — dort ist die Fusion aus drei Fremd-Skills bereits
