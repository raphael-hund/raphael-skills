...
1. Lies `craft/statics.md`: S1–S8, Hook F01–F12, Callout C01–C06, Angle A01–A08 und Briefschema.
2. Lies die zur Aufgabe passenden Beispiele in `craft/referenzkatalog.md`.
