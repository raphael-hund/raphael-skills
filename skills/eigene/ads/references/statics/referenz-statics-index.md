...
**Brief-Format:** `brief-schema.md` ist das Pflicht-Brief-Format (Feld-Reihenfolge,
Grounding-Pflicht, Batch-Kopf) — es war in der alten loads-Liste des Leafs vergessen
worden und gehört zur Pflichtlektüre vor dem ersten Brief.
...
Vier Schritte jede Ad: Avatar ansprechen → Problem → Lösung → CTA. Hook-Formeln
Z1–Z9 stehen in `zac-regan-playbook.md`; `copy-formeln.md` führt F01–F12.
Regan berichtet ~40 Proof-Ads unter seinen besten 50 aus einer Stichprobe von
2.000 Ads; ohne Auswahlverfahren und Erfolgsdefinition unbestätigt (früher
fälschlich Hormozi zugeschrieben).
Kein Zac-Talking-Head als Static-Layout klauen — nur die Sätze.

## Marc Evers (38 Kanal-Videos, 19.08.2026)

Destillat: `../marc-evers-playbook.md`. Für Statics zählt vor allem:
...
- Meme-Statics (Drake) nur als bewusster Kontrast-Test — für das Referenzkonto zu locker als Standard.
...
bestätigt die Referenzkonto-Linie.
...
liegt direkt neben dem Referenzkonto-Website-Check — dieselbe Mechanik, anderes Produkt.
Warnung: US-frei, aber Coaching-/Berater-Zielgruppe. Auf Referenzkonto-Handwerker-ICP nur die
