...
**Diese Datei ist das kanonische Pflicht-Schema für Statics-Briefs** (Festlegung
18.09.2026). `../craft/statics.md` bleibt Stil-/ID-Kanon (Angle-Taxonomie, Visual
Styles, Bild-Produktion), enthält aber keine konkurrierende Brief-Vorlage.
...
> **Ersetzt (08.09.2026):** Die Safe-Zone-Angabe unten (9:16 anlegen, Kern im zentrierten 1:1) ist überholt — kanonisch ist die 3:4-Master-Doktrin in ../teil-statics.md (3:4-Master, Feed 4:5 als lokaler Crop, Story 9:16 als symmetrisches Streifen-Outpaint je 285 px). Die ältere Fassung bleibt als Historie stehen.

**Bild-Beschreibung:** [Szene + Stil + Format + exakter On-Image-Text, konkret genug,
  dass ein Designer/Bildgenerator ohne Rückfrage bauen kann. Safe-Zone gemäss
...
Für die konkrete Bild-Komposition gelten die Layout-Baupläne in
`../creative/2026-07-20-referenz-static-ad-muster.md` und die Visual-Style-Familien in
`visual-styles.md`. Batch-Verteilungsregel: über alle gewählten Layouts zyklen, nicht
auf 2–3 Favoriten clustern.
...
`../../assets/creative-review-template.html` (ein File, JSON-Datenblock, kein Build).
...
- **Ein neues Design ist kein neues Konzept.** Neu ist nur, was Angle, Offer oder
  Persona ändert (siehe `../teil-strategie.md`). Ein Format-Wechsel ist eine Variante
