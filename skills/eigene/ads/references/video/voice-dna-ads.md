...
Quelle: `../korpus/referenz-ads.md` (Meta Ad Library Export, Airtable-Base app9VvWqeSNAOwwmV)
...
Staccato-Paar und damit ein Fail (`forbidden.md` A1 — externes Verbots-Register
unter `/root/.claude/forbidden.md`, nicht Teil des Skills; gilt falls verfügbar).
...
`copywriting/references/voice-dna.md` Abschnitt 4 (externer Skill, falls
installiert): hoher Kaufpreis über 10.000 €
...
5. `forbidden.md` = 0 Treffer (externes Register, falls verfügbar)?
6. Ein CTA, in den letzten 3 Sekunden, mit Risiko-Umkehr?

## Wartung

Korpus-Refresh nur auf Chef-Auftrag (kein mitgeliefertes Skript).
