...
Muster verallgemeinert aus Referenzkonto-Referenzmaterial (Einblendungs-Plan und
...
Beispiel-Tabellenform (aus Referenzkonto-Referenz):
...
Die fünf Dreh-Formate oben bleiben der Referenzkonto-Default nach Static-Sieg.
...
Playbook: `../marc-evers-playbook.md`, Varianten nach Belegen.
...
- Logo-Platzierung, falls gewünscht ("small scribbled das Referenzkonto logo in a corner")
...
Skills. Operative Doktrin lag zuletzt extern im Archiv
(`_archiv/web-1.6.0-bis-2026-09-06/references/bildgenerierung.md` — externer Bestand,
...
- **Markenfarbe nie annehmen.** Farbwerte aus dem Gedächtnis oder von einer alten Quelle
  übernehmen ist ein wiederkehrender Fehler (Referenzkonto-Fall: "#E30613" musste explizit gegen
