...
- **Suchnachfrage prüfen:** erscheinen für die Kundenleistung Wettbewerber als Google-Anzeigen,
  existiert Nachfrage → SEO/SEA sinnvoll. Sonst zuerst Nachfrage über FB/IG erzeugen (r-ads).
- **Brand-Protect:** bei signifikantem FB/IG-Spend eine Branded-Search-Kampagne (Marken-Keywords)
  als r-seo-Aufgabe anlegen — die Social-erzeugte Direktsuche ist der günstigste Lead. Mit r-ads
