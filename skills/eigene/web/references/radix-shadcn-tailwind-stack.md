...
**Verbund (08.09.2026):** Diese Stack-Doktrin (Radix/Base UI, shadcn kopiert, Tailwind als Token-Layer, `motion/react`, App Router) ist wieder der Standard. Versionen, Projektstruktur, Export und Client/Server-Grenze: [stack.md](stack.md); geprüfter Starter: `assets/react-starter/`.
