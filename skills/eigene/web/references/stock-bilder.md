...
**Verbund (08.09.2026):** Shutterstock über `scripts/stock.mjs` bleibt der Weg für lizenzierte Fotos in Kundenseiten. Logos, Icons und Referenzfotos ohne Rechte-Rückfrage: [image-search.md](image-search.md).
