...
Dieses Modul wird nach [GPT Image](gpt-image.md) geladen, wenn Bewegung die Darstellung erklärt oder ausdrücklich gewünscht ist. Es ergänzt HTML/CSS/Vanilla JavaScript. Eine Service-Website braucht weder React noch einen Film, um hochwertige Bilder einzusetzen.
