...
**Verbund (08.09.2026):** Diese Datei beschreibt die Werkzeuge (Refero-MCP, `scripts/inspiration.mjs`, `scripts/design-mcp.mjs`). Der Galerie-Katalog mit 56 Quellen in vier Stufen steht in [inspiration-galleries.md](inspiration-galleries.md), die Auswahl- und Belegmethode in [inspiration.md](inspiration.md), Service-Referenzen in [service-learning.md](service-learning.md).
