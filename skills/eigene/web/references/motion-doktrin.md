...
Hier steht nur, was **an Raphaels Web-Build hängt** und in der design-Quelle
nicht stehen kann: die Bindung an die lokale Komponentenbibliothek, den
Bibliotheks-Tresor und die Werte in `ui-components/lib/ease.ts`.
