...
eval_scorecard:
  ...
  laeufe:
    ...
    - "evals/run-eval-umfang.mjs — 40 Evals: hat jede noch ihre Faelle?"
    ...
    - "evals/run-port-vergabe-check.mjs — 2 Regeln: belegen zwei Evals denselben Testserver-Port? (2s)"
...
node evals/run-eval-umfang.mjs       # hat jede Eval überhaupt noch ihre Fälle?
                                     # fährt 40 Evals nacheinander: 13 Min (gemessen 02.08.2026)
```
