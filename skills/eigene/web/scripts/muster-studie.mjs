...
if (args.includes('--help') || args.includes('-h')) {
  console.log('Usage: node scripts/muster-studie.mjs --url https://example.ch --slug name [--out references/muster-bibliothek]');
  console.log('Spawnt shot-sweep.mjs gegen --url und schreibt Shots nach <out>/<slug>/shots.');
  process.exit(0);
}
