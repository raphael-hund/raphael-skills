# Quellen 2026-08 — Mechaniken mit Datum

Eine Zeile = ein Fakt. Kein fremder Wortlaut. Der Rohkorpus
(`raphael-brain/raw/2026-08-13-seo-skill-corpus/`) wurde mit dem Second Brain
am 19.09.2026 gelöscht und ist lokal nicht mehr abrufbar.
...
- Local/Maps: echte Kategorie + echter Name; Keyword-Name riskiert Sperre (2026-08-13, 2087859868866576599).
- GEO: Engines täglich mehrfach samplen; eigene Zahl zitieren (2026-08-05, 2084980608753631314).
- 90-Tage Copilot: 10 fixe Buyer-Questions; Pos. 8–20 zuerst (2026-07-31, 2083164906480656384).
- Parasite-pSEO auf Medium/Substack/YouTube/GitHub = Graustufen (2026-08-04, 2084611086607601673).

## edward.builds (8 Reel-Transkripte 2026-08-13 + Artikel)

Reels in `edward-builds/transcripts/` (Profil-Listing failte, einzelne `/reel/ID/` liefen):

- LinkedIn-Post in erster Person als Entity-Claim kann in AIO landen (Reel `Db6ZRGlMvx5`, 2026-08-13).
- Local-Paket: GBP + 10 echte Reviews + echte Fotos + enge Money-Pages + lokale Guest-Posts, nur Stadt-Keywords (Reel `DW14ZxIjPVv`).
- Journalisten-Börse (sourceofsources / HARO-Nachfolger): Off-Topic oder KI-Text = Account-Bann (Reel `DCNILHvCIGJ`).
- 80-Dollar-Pressemitteilung, Claim in Unterzeile + Satz 1, Syndikation speist AIO (Reel `DTyajVVjPok`) — Graustufen wenn nur zur LLM-Manipulation.
- BOFU-Seiten ~400 Wörter, Keyword in Title und Slug wenn die SERP beides leer lässt (Reel `Db3lX6nMraa`).
- Maps-Routen-Farm / Phone-Farm als Nachfrage-Signal (Reel `DORM5NEjbRh`) — Graustufen, nicht Default.
- Fake-Promi-Check-in für Maps-Suchen (Reel `DG1FRCQCSJQ`) — Graustufen/rechtlich.
- Podcast-Matching für Gast-Backlinks (Reel `CzVVx3mMZYm`).
- Keyword im ersten Satz der Video-Description; Shorts/Reels/TikTok können in <24 h in Google stehen (2024-06-23).
- Manuell auf IG/YT, kein Shared-IP (2025-11-11).
- „Reddit“-Resource + GSC-Bridges (2026-07-14).
- GSC Pages-CSV → fehlende H2 auf der Top-URL, dann Link zur schwachen Seite (2026-07-23).
- cheap/affordable im Title; Micro-Influencer-Descriptions mit Keyword vorn (2026-08-11).

## heytony.agency (8 Reel-Transkripte 2026-08-13 + Artikel)

Reels in `heytony/transcripts/`:

- AnswerThePublic-Fragen + Top-3-SERP in ChatGPT + fremde H-Tags als Outline, dann 2–3 alte rankende Posts darauf linken (Reel `DIFgHQsNxPw`).
- SEO = Relevanz + Autorität + UX; Ads enden mit dem Budget (Reel `DNlAQNbtK_-`).
- Opportunitätskosten: nicht starten vs. 12 Monate zahlen (Reel `DLXzb_nuSXY`).
- Behauptung 15 % neue Queries/Tag; ein Wochen-Post zu Kundenfragen kann ChatGPT-Empfehlungen bringen (Reel `DXUaBoiETQj`).
- `sitemap.xml` finden und in GSC einreichen (Reel `DQEyHDODVQO`).
- `site:domain "keyword"` → 3–5 Treffer intern zur Zielseite verlinken (Reel `DNQidJgtA3n`).
- GSC als Domain-Property, DNS-TXT, dann Sitemap (Reel `DHlW5AGO3d8`).
- Compact-Keywords-Kurs intern durchziehen (Reel `DbQ-NJDxDKr`).
...
Roh (mit dem Brain am 19.09.2026 gelöscht): `bookmark-2026-08-30-seo-buildinpublic-capture.md`.
...
Roh (mit dem Brain am 19.09.2026 gelöscht): `bookmark-2026-08-30-seo-diamante-capture.md`.
...
Roh (mit dem Brain am 19.09.2026 gelöscht): `bookmark-2026-08-30-seo-harrysanders-capture.md`.
...
Roh (mit dem Brain am 19.09.2026 gelöscht): `bookmark-2026-08-30-seo-neilpatel-capture.md`.
...
Siehe `.../youtube/distill.md` und `last30days-or-failure.md` (2026-08-13).

## Google Policy

https://developers.google.com/search/docs/essentials/spam-policies — Stand 2026-05-15.
