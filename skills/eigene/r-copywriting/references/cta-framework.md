...
**TLDR:** Der Hook muss gleichzeitig neugierig machen, das Angebot grob erkennbar machen
...
(Zeitrahmen + Thema + Zielgruppe = alle drei Funktionen).

### Copy-Diagnose: Curious vs. Committed
...
Zahlungsfähigkeit im Hook **nie** über Preis/Umsatz direkt ansprechen, sondern über eine
**Situation, die nur die Zielgruppe erlebt**:
- **B2C:** Job-/Alltags-Realität als Proxy (z. B. „…obwohl der 9-to-5-Job kaum Zeit lässt"
  → filtert nebenbei nach Einkommen).
- **B2B:** Team-Größe, Umsatz-Stufe oder Prozess als Proxy (z. B. „…wenn schon ein Vertriebsteam
  Termine verwaltet") statt „ab 50.000 € Umsatz".
...
- Nur **echte** Verknappung/Fristen (kein Fake-Countdown → § 5 UWG irreführend).
...
- Mehrere gleichwertige CTAs nebeneinander.
- Übertreibung/Garantie ohne einlösbare Bedingung (UWG-Risiko).

## Format
Pro Asset 2–3 CTA-Varianten für den A/B-Test, alle in Brand-Voice, alle UWG-sauber.
