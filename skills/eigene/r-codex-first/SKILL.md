...
# r-codex-first — Arbeitspaket an Codex delegieren, Claude prüft
...
4. **Streng reviewen (Claude, `r-code-review`)** — jeden Fund als **pass/fail + Datei:Zeile +
...
- Läuft Codex-Seat 1 ins leere Quota-Fenster, greift der Fallback auf Seat 2. Sind beide leer:
  Aufgabe selbst machen oder an Kimi (`r-kimi-first`) geben.
